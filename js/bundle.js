...
function calc() {
  ...
  function initLocalSettings(activeClass) {
    var genders = document.querySelectorAll("#gender div");
    var ratios = document.querySelectorAll(".calculating__choose_big div");
  ...
  function getStaticInformation(parentSelector, activeClass) {
    ...
    document.querySelector(parentSelector).addEventListener("click", function (evt) {
      ...
      if (target.hasAttribute("data-ratio")) {
        ...
        localStorage.setItem("ratio", "".concat(ratio));
      } else {
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../services/services */ "./js/services/services.js");
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    ...
    return _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) element.classList.add("menu__item");else this.classes.forEach(function (className) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_20__.getResource)("http://localhost:3000/menu").then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (evt) {
      ...
      var json = JSON.stringify(Object.fromEntries(new FormData(form).entries()));
      (0,_services_services__WEBPACK_IMPORTED_MODULE_8__.postData)("http://localhost:3000/requests", json).then(function (response) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.showModalWindow)(".modal", modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_7__.hideModalWindow)(".modal");
    }, 3000);
  }
}
...
/* harmony export */   hideModalWindow: function() { return /* binding */ hideModalWindow; },
...
function modal(modalSelector, triggerSelector, modalTimerId) {
  ...
  modalTrigger.forEach(function (item) {
    return item.addEventListener("click", function () {
      return showModalWindow(modalSelector, modalTimerId);
    });
  });
...
function slider(_ref) {
  ...
  function slideMove(type, index) {
    ...
    current.textContent = slideIndex < 10 ? "0".concat(slideIndex) : slideIndex;
    dots.forEach(function (dot) {
      return dot.classList.remove("dot-item_active");
    });
    dots[slideIndex - 1].classList.add("dot-item_active");
  }
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  tabsParent.addEventListener("click", function (evt) {
    var target = evt.target;
    if (!(target && target.matches("div".concat(tabsSelector)))) return;
    hideTabContent();
...
function timer(id, deadLine) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.textContent = t.days >= 0 && t.days < 10 ? "0".concat(t.days) : t.days;
      hours.textContent = t.hours >= 0 && t.hours < 10 ? "0".concat(t.hours) : t.hours;
      minutes.textContent = t.minutes >= 0 && t.minutes < 10 ? "0".concat(t.minutes) : t.minutes;
      seconds.textContent = t.seconds >= 0 && t.seconds < 10 ? "0".concat(t.seconds) : t.seconds;
    }
  }
...
document.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.showModalWindow)(".modal", modalTimerId);
  }, 5000);
